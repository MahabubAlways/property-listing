...
export const Filter = ({ toggleFilter, handleFilterChange, clearFilter }) => {
    const myForm = useRef(null);
    return (
          <form ref={myForm} className="filter">
              ...
              <div className="filterBox">
                  <label>&nbsp;</label>
                  <button className="btn-clear"  onClick={(e) => clearFilter(e, myForm)}>Clear</button>
              </div>
